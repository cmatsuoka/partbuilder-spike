...
from partbuilder.common import isurl
from partbuilder import errors, mangling
from partbuilder.errors import PartbuilderPluginCommandError
from partbuilder.plugins.v1 import PluginV1, _python

logger = logging.getLogger(__name__)


class UnsupportedPythonVersionError(errors.PartbuilderError):

    fmt = "Unsupported python version: {python_version!r}"


class PartbuilderPluginPythonFileMissing(errors.PartbuilderError):
...
class PythonPlugin(PluginV1):
    ...
    def _get_normalized_property_set(
        ...
        for entry in property_list:
            if isurl(entry):
                ...
                if not entry_file:
                    raise PartbuilderPluginPythonFileMissing(
    ...
    def _install_project(self):
        ...
        except errors.PartbuilderCommandError:
            logger.warning(
        ...
        #  this.
        with contextlib.suppress(PartbuilderPluginCommandError):
