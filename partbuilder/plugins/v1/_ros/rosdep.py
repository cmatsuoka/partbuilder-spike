...
class RosdepPackageNotFoundError(errors.PartbuilderError):
...
class RosdepDependencyNotResolvedError(errors.PartbuilderError):
...
class RosdepUnexpectedResultError(errors.PartbuilderError):
    fmt = (
...
class RosdepInitializationError(errors.PartbuilderError):
