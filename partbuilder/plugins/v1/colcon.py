...
class ColconInvalidSystemDependencyError(errors.PartbuilderError):
    fmt = (
...
class ColconUnsupportedDependencyTypeError(errors.PartbuilderError):
    fmt = (
...
class ColconWorkspaceIsRootError(errors.PartbuilderError):
    fmt = (
...
class ColconAptDependencyFetchError(errors.PartbuilderError):
...
class ColconPackagePathNotFoundError(errors.PartbuilderError):
