...
class CatkinInvalidSystemDependencyError(errors.PartbuilderError):
    fmt = (
...
class CatkinUnsupportedDependencyTypeError(errors.PartbuilderError):
    fmt = (
...
class CatkinWorkspaceIsRootError(errors.PartbuilderError):
    fmt = "source-space cannot be the root of the Catkin workspace; use a subdirectory."


class CatkinCannotResolveRoscoreError(errors.PartbuilderError):
    fmt = "Failed to determine system dependency for roscore."


class CatkinAptDependencyFetchError(errors.PartbuilderError):
...
class CatkinNoHighestVersionPathError(errors.PartbuilderError):
...
class CatkinGccVersionError(errors.PartbuilderError):
...
class CatkinPackagePathNotFoundError(errors.PartbuilderError):
...
class CatkinPackageNotFoundError(errors.PartbuilderError):
