...
class GrammarProcessor:
    ...
    def __init__(
        ...
        *,
        # FIXME:SPIKE: should use Config instead of Any
        transformer: Callable[[List[Statement], str, Any], str] = None
    ) -> None:
        ...
        for section in grammar:
            if isinstance(section, str):
                ...
                if _ELSE_FAIL_PATTERN.match(section):
                    ...
                    primitives.add(self._transformer(call_stack, section, self.config))
